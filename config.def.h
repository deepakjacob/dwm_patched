...
static const char *colors[][3]      = {
	...
	[SchemeTabActive]  = { col_gray4, col_cyan,  col_cyan},
	[SchemeTabInactive]  = { col_gray4, col_cyan,  col_cyan},
};
...
const char *spcmd4[] = {"st", "-n", "spterm1", "-g", "120x30", NULL };
...
static const Rule rules[] = {
  ...
  { NULL,		  "spfm",		NULL,		SPTAG(1),		1,0,0.			 -1 },
	...
	{ NULL,		  "spterm1",	NULL,		SPTAG(3),		1,0,0,			 -1 },
 };
